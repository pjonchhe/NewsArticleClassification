...
val rf = new RandomForestClassifier().setLabelCol("label").setFeaturesCol("features").setNumTrees(200)

val pipeline = new Pipeline().setStages(Array(indexer,tokenizer, remover, hashingTF, idf, rf))
